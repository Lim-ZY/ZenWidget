package com.example.zenwidget.layout
...
import com.example.zenwidget.layout.WidgetTextDimensions.captionFontSizeAndMaxLines
import com.example.zenwidget.layout.WidgetTextDimensions.widgetPadding
import com.example.zenwidget.layout.WidgetTextDimensions.primaryTextFontSizeAndMaxLines
import com.example.zenwidget.utils.ActionUtils.actionStartDemoActivity
import com.example.zenwidget.utils.FontUtils.calculateFontSizeAndMaxLines
import com.example.zenwidget.utils.MediumWidgetPreview
import com.example.zenwidget.utils.SmallWidgetPreview
...
fun LongTextLayout(
    ...
    Box(
        modifier = GlanceModifier
            .background(ImageProvider(R.drawable.widget_glass_panel))
    ) {
        Scaffold(
